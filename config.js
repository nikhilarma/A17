...
// Auth information
global.pairNumber = "918109539227";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["918109539227", "918109539227"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["918109539227", "918109539227"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["918109539227"];
global.OwnerName = process.env.OWNER_NAME || "nik";
global.BotName = process.env.BOT_NAME || "sᴘʏاا̽ـ꯭";
global.packname = process.env.PACK_NAME || "•⏤⵿༄ 𝆺𝅥⃝⃪⃜❤️ᴄ͢͢͢ʀɪᴍɪɴᴀʟ𓆪ꪾ❦︎ 𝆺𝅥⃝🍷";
global.author = "By: Kai";
global.BotSourceCode = "https://github.com/Kai0071/A17";
global.SupportGroupLink = "https://chat.whatsapp.com/GhRMVDCoeAdzILfl";
